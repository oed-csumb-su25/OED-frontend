...
const LocaleTranslationData = {
	"en": {
		...
		"conversion.warning.segment.neutral": "The slope/intercept is being used but both values are 0. Are you sure this is what you want?",
	...
	"fr": {
		...
		"conversion.error.segment.startTimeMismatch": "L'heure de début doit correspondre à l'heure de fin du segment précédent ({endTime})",
		"conversion.error.segment.endTimeMismatch": "L'heure de fin doit correspondre à l'heure de début du segment suivant ({startTime})",
		...
		"conversion.error.datetime.invalid": "Format invalide pour {field}. Utilisez YYYY-MM-DD HH:mm:ss",
		...
		"conversion.segment.delete.error": "Une erreur est survenue lors de la suppression du segment. Veuillez réessayer.",
		"conversion.segment.delete.success": "Segment de conversion supprimé avec succès.",
		"conversion.segment.split.error": "Une erreur est survenue lors de la scission du segment. Veuillez réessayer.",
		"conversion.segment.split.success": "Segment de conversion scindé avec succès.",
		"conversion.segment.save.error": "Une erreur est survenue lors de l'enregistrement du segment. Veuillez réessayer.",
		...
		"conversion.warning.segment.neutral": "La pente et l'ordonnée à l'origine sont utilisées mais leurs valeurs sont toutes deux égales à 0. Êtes-vous sûr que c'est ce que vous voulez?",
	...
	"es": {
		...
		"conversion.error.segment.startTimeMismatch": "La hora de inicio debe coincidir con la hora de fin del segmento anterior ({endTime})",
		"conversion.error.segment.endTimeMismatch": "La hora de fin debe coincidir con la hora de inicio del siguiente segmento ({startTime})",
		"conversion.error.segment.splitTime": "La hora de división debe estar estrictamente entre el inicio y el fin del segmento.",
		"conversion.error.datetime.invalid": "Formato inválido para {field}. Use YYYY-MM-DD HH:mm:ss",
		...
		"conversion.segment.delete.error": "Ocurrió un error al eliminar el segmento. Por favor, inténtelo de nuevo.",
		...
		"conversion.warning.segment.neutral": "La pendiente y la intersección se están utilizando, pero ambos valores son 0. ¿Está seguro de que esto es lo que desea?",
