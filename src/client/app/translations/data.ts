...
const LocaleTranslationData = {
	"en": {
		...
		"daily.patterns": "Patterns - Daily",
		"daily.patterns.create": "Create a Day",
		"daily.patterns.create.name.required": "Day name is required",
		"daily.patterns.create.name.exists": "Day already exists",
		"daily.patterns.edit": "Details/Edit Day",
		"daily.patterns.slope.intercept.zero": "Both the slope and the intercept are zero. Are you sure you want to save this pattern?",
		"daily.patterns.start.hour": "Start Hour",
		"daily.patterns.end.hour": "End Hour",
	...
	"fr": {
		...
		"daily.patterns.create.name.exists": "Day already exists\u{26A1}",
