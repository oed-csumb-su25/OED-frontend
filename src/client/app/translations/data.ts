...
const LocaleTranslationData = {
	"en": {
		...
		"conversion.error.segment.neutral": "Segment has 0 slope and intercept and no pattern!",
		"conversion.error.segment.startTimeMismatch": "Start time must match end time of previous segment ({endTime})",
		"conversion.error.segment.endTimeMismatch": "End time must match start time of next segment ({startTime})",
		"conversion.error.segment.splitTime": "Split time must be strictly between the segment start and end.",
		"conversion.error.datetime.invalid": "Invalid {field} format. Use YYYY-MM-DD HH:mm:ss",
		...
		"conversion.segment.delete.error": "An error occurred while deleting the segment. Please try again.",
		"conversion.segment.split.error": "An error occurred while splitting the segment. Please try again.",
		"conversion.segment.save.error": "An error occurred while saving the segment. Please try again.",
		...
		"conversion.warning.segment.neutral": "Warning: This segment has no slope, intercept, or pattern. It will not affect conversions.",
		...
		"day.delete.button": "Delete Day",
		"day.delete.confirm": "Are you sure you want to delete this day?",
		"day.delete.error": "Failed to delete day. Please try again.",
		"day.delete.success": "Successfully deleted day.",
		"day.edit": "Details/Edit Day",
		"day.edit.discard": "Discard Day Changes",
		"day.edit.error": "Failed to edit day. Please try again.",
		"day.edit.save": "Save Day Changes",
		...
		"day.segments.delete.confirm": "Are you sure you want to delete this segment?",
		"day.segments.delete.confirm.button": "Delete Segment",
		"day.segments.edit.save": "Save Segment",
		"day.segments.table.edit": "Edit",
		"day.segments.table.intercept": "Intercept",
		"day.segments.table.slope": "Slope",
		"day.segments.table.timeRange": "Time Range",
		"day.segments.table.title": "Segments Table",
		"day.slope.intercept.zero": "Both the slope and the intercept are zero. Are you sure you want to save this pattern?",
	...
	"fr": {
		...
		"conversion.delete.segment.earlier": "Êtes-vous sûr de vouloir supprimer le segment de {start} à {end} et mettre à jour le segment précédent?\u{26A1}",
		"conversion.delete.segment.later": "Êtes-vous sûr de vouloir supprimer le segment de {start} à {end} et mettre à jour le segment suivant?\u{26A1}",
		...
		"conversion.error.segment.neutral": "Le segment a une pente et une interception nulles et aucun modèle! ⚡",
		"conversion.error.segment.startTimeMismatch": "L'heure de début doit correspondre à l'heure de fin du segment précédent ({endTime})\u{26A1}",
		...
		"conversion.overall.discard": "Annuler les modifications globales\u{26A1}",
		"conversion.overall.save": "Enregistrer la conversion globale\u{26A1}",
		"conversion.overall.subtitle": "Cette section définit la conversion globale entre les unités.\u{26A1}",
		"conversion.pattern": "Pattern\u{26A1}",
		"conversion.pattern.no": "No Pattern\u{26A1}",
		"conversion.represent": "Conversion Represent:\u{26A1}",
		"conversion.segment.delete.error": "Une erreur est survenue lors de la suppression du segment. Veuillez réessayer.\u{26A1}",
		"conversion.segment.split.error": "Une erreur est survenue lors de la scission du segment. Veuillez réessayer.\u{26A1}",
		"conversion.segment.save.error": "Une erreur est survenue lors de l’enregistrement du segment. Veuillez réessayer.\u{26A1}",
		...
		"conversion.table.split.earlier": "Diviser avant\u2191\u{26A1}",
		...
		"conversion.warning.segment.neutral": "Attention : Ce segment n’a ni pente, ni interception, ni motif. Il n’aura aucun effet sur les conversions.\u{26A1}",
		...
		"day.delete.button": "Supprimer le Jour",
		"day.delete.confirm": "Êtes-vous sûr de vouloir supprimer ce jour ?",
		"day.delete.error": "Échec de la suppression du jour. Veuillez réessayer.",
		"day.delete.success": "Jour supprimé avec succès.",
		"day.edit": "Détails/Modifier Jour",
		"day.edit.discard": "Annuler les modifications du jour",
		"day.edit.error": "Échec de la modification du jour. Veuillez réessayer.",
		"day.edit.save": "Enregistrer les modifications du jour",
		...
		"day.saturday": "Samedi",
		"day.segments.delete.confirm": "Êtes-vous sûr de vouloir supprimer le segment?",
		"day.segments.delete.confirm.button": "Supprimer le Segment",
		"day.segments.edit.save": "Enregistrer le Segment",
		"day.segments.table.edit": "Modifier",
		"day.segments.table.intercept": "Ordonnée à l'origine",
		"day.segments.table.slope": "Pente",
		"day.segments.table.timeRange": "Plage horaire",
		"day.segments.table.title": "Tableau des segments",
		"day.slope.intercept.zero": "La pente et l'ordonnée à l'origine sont toutes deux nulles. Êtes-vous sûr de vouloir enregistrer ce modèle ?",
	...
	"es": {
		...
		"conversion.error.segment.neutral": "¡El segmento tiene pendiente e intersección en cero y ningún patrón! ⚡",
		"conversion.error.segment.startTimeMismatch": "La hora de inicio debe coincidir con la hora de fin del segmento anterior ({endTime})\u{26A1}",
		...
		"conversion.overall": "Conversión General\u{26A1}",
		"conversion.overall.delete": "Eliminar la conversión general\u{26A1}",
		"conversion.overall.discard": "Descartar los cambios generales\u{26A1}",
		...
		"conversion.segment.delete.error": "Ocurrió un error al eliminar el segmento. Por favor, inténtelo de nuevo.\u{26A1}",
		"conversion.segment.split.error": "Ocurrió un error al dividir el segmento. Por favor, inténtelo de nuevo.\u{26A1}",
		"conversion.segment.save.error": "Ocurrió un error al guardar el segmento. Por favor, inténtelo de nuevo.\u{26A1}",
		"conversion.segments.table": "Tabla de segmentos de conversión\u{26A1}",
		"conversion.segments.table.subtitle": "Esta sección muestra cómo se comporta la conversión durante períodos específicos.\u{26A1}",
		...
		"conversion.split.datetime.prompt": "Ingrese la fecha y hora (AAAA-MM-DD HH:mm:ss) para dividir el segmento:\u{26A1}",
		...
		"conversion.table.split.earlier": "Dividir antes\u2191\u{26A1}",
		...
		"day.delete.button": "Eliminar Día",
		"day.delete.confirm": "¿Estás seguro de que quieres eliminar este día?",
		"day.delete.error": "No se pudo eliminar el día. Por favor, inténtalo de nuevo.",
		"day.delete.success": "Día eliminado con éxito.",
		"day.edit": "Detalles/Editar Día",
		"day.edit.discard": "Descartar los cambios del día",
		"day.edit.error": "No se pudo editar el día. Por favor, inténtalo de nuevo.",
		"day.edit.save": "Guardar los cambios del día",
		...
		"day.saturday": "Sábado",
		"day.segments.delete.confirm": "¿Estás seguro de que quieres eliminar este segmento?",
		"day.segments.delete.confirm.button": "Eliminar segmento",
		"day.segments.edit.save": "Guardar segmento",
		"day.segments.table.edit": "Editar",
		"day.segments.table.intercept": "Intersección",
		"day.segments.table.slope": "Pendiente",
		"day.segments.table.timeRange": "Rango horario",
		"day.segments.table.title": "Tabla de segmentos",
		"day.slope.intercept.zero": "Tanto la pendiente como la intersección son cero. ¿Seguro que quieres guardar este modelo?",
